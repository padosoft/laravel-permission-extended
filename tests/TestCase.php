...
use Padosoft\Laravel\PermissionExtended\PermissionExtendedServiceProvider;
...
abstract class TestCase extends Orchestra
{
    ...
    {
        $app['config']->set('permission.models.permission', \Padosoft\Laravel\PermissionExtended\Models\Permission::class);
        $app['config']->set('permission.models.role', \Padosoft\Laravel\PermissionExtended\Models\Role::class);
